/* IndependentSet.java
   ...
   Starter code by B. Bird - 11/19/2014

   @Chenkai Hao Nov 2014
*/
...
public class IndependentSet{
	...
	*/
	static VertexSet MaximumIndependentSet(int[][] G){
        ...
        VertexSet currentSet = new VertexSet(numVerts);
        
        VertexSet bestSet = new VertexSet(numVerts);
        VertexSet forbidSet = new VertexSet(numVerts);
        
        findSets(G,bestSet,currentSet,forbidSet,0);
    ...
    public static void findSets(int[][] G, VertexSet b, VertexSet s, VertexSet f, int v){
...
//        b.printVertices();
        ...
        int n = G.length;
        //System.out.println("the length of G is "+n);
        if(v == n){
        ...
        //Case where v is not added to s
        VertexSet ff = new VertexSet(n);
        ff.copyFrom(f);
        ff.addVertex(v);
        
       //if( ff.isInSet(v) ){
            //System.out.println("the forbidden set : ");
            //f.printVertices();
        findSets(G,b,s,ff,v+1);
            
       //}
        
        //v can be added to s if it is not in f
        if( !f.isInSet(v) ){
            s.addVertex(v);
            
            //System.out.println("the current set : ");
            //s.printVertices();
